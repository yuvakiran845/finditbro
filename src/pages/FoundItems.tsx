...
const FoundItems = () => {
  ...
  const locations = useMemo(() => {
    const uniqueLocations = [...new Set(mockFoundItems.map((item) => item.location))];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Browse through reported found items. If something here belongs to you, reach out to the finder and claim your belonging.
            </p>
          </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <p className="text-muted-foreground">
              Showing <span className="text-foreground font-medium">{filteredItems.length}</span> found items
            </p>
          </div>
